...
const onSubmit = handleSubmit(async (values: ITransactionForm) => {
  loginErrorMessage.value = "";
  isLoading.value = true;

  try {
    await api.post("/sale-transaction", values);
...
<template>
  <div class="flex justify-center">
    <div class="w-full m-4 bg-white rounded-lg shadow sm:max-w-lg">
        ...
        <form class="space-y-4 md:space-y-6" @submit="onSubmit">
          <div>
            <label
              ...
              :class="
                !errors.description ? inputClass.label : errorInputClass.label
              "
            >
              Description</label
            >
            <input
              ...
              :class="
                !errors.description ? inputClass.input : errorInputClass.input
              "
            />
          ...
          <div>
            <label
              ...
              class="block mb-2 text-sm font-medium"
              :class="
                !errors.unitPrice ? inputClass.label : errorInputClass.label
              "
            >
              Unit price</label
            >
            <input
              ...
              :class="
                !errors.unitPrice ? inputClass.input : errorInputClass.input
              "
            />
          ...
          <div>
            <label
              for="amount"
              class="block mb-2 text-sm font-medium"
              :class="!errors.amount ? inputClass.label : errorInputClass.label"
            >
              Unit price</label
            >
            <input
              ...
              v-model="amount"
              v-bind="amountAttrs"
              :class="!errors.amount ? inputClass.input : errorInputClass.input"
            />
